    ...
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket" id="ul1">
       ...
       <li><a href="<%=path%>/builds/mngbuildpage"  target="mainFrame"  class="qwe"><i class="fa fa-th-list"></i> <span>楼盘管理</span></a></li>
        <li><a href="<%=path%>/user/mgnuserpage"  target="mainFrame"  class="heig1"><i class="fa fa-th-list"></i> <span>用户管理</span></a></li>
         <li><a href="<%=path%>/articleType/articleTypePage"  target="mainFrame"  class="heig1"><i class="fa fa-th-list"></i> <span>文章类别管理</span></a></li>
        ...
        <li class="nav-parent"><a href="<%=path%>/agency/mgnagency" target="mainFrame"><i class="fa fa-th-list" class="qwe"></i> <span>经销商管理</span></a>
          <ul class="children">
            <li><a href="<%=path%>/agency/mgnagency?checked=Y" target="mainFrame" class="heig1"><i class="fa fa-caret-right"></i>审核通过</a> </li>
            <li><a href="<%=path%>/agency/mgnagency?checked=N" target="mainFrame" class="heig1"><i class="fa fa-caret-right"></i> 未审核</a></li>
            <li><a href="<%=path%>/agency/mgnagency?checked=F" target="mainFrame" class="heig1"><i class="fa fa-caret-right"></i>未通过</a></li>
          </ul>
        </li>
        
        <li class="nav-parent"><a href="" target="mainFrame" class="qwe"><i class="fa fa-th-list"></i> <span>活动管理</span></a>
            <ul class="children">
                <li><a href="<%=path%>/activity/mgnActivitypage?actvt=agc" target="mainFrame" class="heig1"><i class="fa fa-caret-right"></i> 经销商活动</a></li>
                <li><a href="<%=path%>/activity/mgnActivitypage?actvt=mgn" target="mainFrame" class="heig1"><i class="fa fa-caret-right"></i> 管理员活动</a></li>
            </ul>
        </li>
      </ul>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".heig1").bind("click",function(){
			document.getElementById( "iframe1" ).className="heig";
		});
	})
